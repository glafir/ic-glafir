...
#      if(@sunrise == nil)
#        if ( ((@latitude > 66.5622) && (doy > 79) && (doy < 267)) ||
#           ((@latitude < -66.5622) && ((doy < 83) || (doy > 263))) )
...
#          newjd = findRecentSunrise(@julian_day)
#          @sunrise = calcSunriseUTC(newjd) + @zone
#        elsif ( ((@latitude > 66.5622) && ((doy < 83) || (doy > 263))) ||
#          ((@latitude < -66.5622) && (doy > 79) && (doy < 267)) )
...
#          newjd = findNextSunrise(@julian_day)
#          @sunrise = calcSunriseUTC(newjd) + @zone
#        else
...
#          # if Southern hemisphere and fall or winter, use
#          # previous sunrise and next sunset
#          newjd = findNextSunset(@julian_day)
...
#          newjd = findRecentSunset(@julian_day)
#          @sunset = calcSunsetUTC(newjd) + @zone
#        else
