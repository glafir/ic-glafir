...
require "sunriseset"
layout "application_netzke", only: [:admin_al, :admin_aphub, :admin_ap, :admin_tt, :admin_stations, :admin_station_zones, :admin_rw_routes, :admin_rw_eltrains_routes, :admin_rw_eltrains_timetables, :admin_rw_directions]
