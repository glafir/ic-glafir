...
#    @airports.each {|airport|
      ...
      weather.temperature = airport_wheather.temperature
      weather.min_temperature = airport_wheather.min_temperature
      weather.max_temperature = airport_wheather.max_temperature
      ...
      airport_wheather.main.each {|w|
        ...
        weather_state.weather_icon_id = w['id']
        weather_state.save
      }
