...
ActiveRecord::Schema.define(version: 2026_08_06_214203) do
  ...
  create_table "aircraft_companies", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "aircraft_types", id: :integer, charset: "utf8", force: :cascade do |t|
    t.string "atype"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "aircraft_wake_categories", id: :integer, charset: "utf8", force: :cascade do |t|
    t.string "category"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "aircrafts", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "airline_codeshares", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "airpor_size_states", id: :integer, charset: "utf8", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "airport_air_traffics", id: :integer, charset: "utf8", force: :cascade do |t|
    t.string "name"
  ...
  create_table "airport_distances", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "airport_states", id: :integer, charset: "utf8", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "airport_terminal_gates", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "airport_terminals", id: :integer, charset: "utf8", force: :cascade do |t|
    t.integer "airport_id"
    t.string "terminal"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "airports", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "aphubs", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "flash_message_states", id: :integer, charset: "utf8", force: :cascade do |t|
    t.string "state"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "flash_messages", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "flight_types", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "runway_aps", id: :integer, charset: "utf8", force: :cascade do |t|
    t.integer "airport_id"
  ...
  create_table "rw_directions", charset: "utf8", force: :cascade do |t|
  ...
  create_table "rw_eltrains_routes", charset: "utf8", force: :cascade do |t|
    t.integer "station_id"
  ...
  create_table "rw_eltrains_timetables", charset: "utf8", force: :cascade do |t|
    t.integer "rw_eltrains_route_id"
    t.integer "direction"
    t.time "time_start"
    t.time "time_finish"
    t.integer "w1"
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.integer "eltrains_number"
    t.integer "station_id"
  end

  create_table "rw_routes", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "sign_in_failures", id: :integer, charset: "utf8", force: :cascade do |t|
    t.string "email"
    t.string "ip_address"
    t.string "user_agent"
    t.datetime "created_at", null: false
  ...
  create_table "station_zones", id: :integer, charset: "utf8", force: :cascade do |t|
    t.string "station_id"
    t.string "zone"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "stations", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "statuses", id: :integer, charset: "utf8", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "terminals", id: :integer, charset: "utf8", force: :cascade do |t|
    t.string "name"
    t.string "marking"
    t.integer "floor"
    t.integer "reception"
  ...
  create_table "timetableaps", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "timetablesap_flights", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "towns", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "user_themes", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "user_tracings", id: :integer, charset: "utf8", force: :cascade do |t|
    t.integer "user_id", null: false
  ...
  create_table "weather_states", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "weathers", id: :integer, charset: "utf8", force: :cascade do |t|
    t.integer "place_id"
    t.float "temperature"
