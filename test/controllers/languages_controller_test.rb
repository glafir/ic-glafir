...
class LanguagesControllerTest < ActionController::TestCase
  ...
  test "should create language" do
    assert_difference('Language.count') do
      post :create, language: { lang: @language.lang, lang_iata: @language.lang_iata, lang_iso: @language.lang_iso }
    end
  ...
  test "should update language" do
    patch :update, id: @language, language: { lang: @language.lang, lang_iata: @language.lang_iata, lang_iso: @language.lang_iso }
    assert_redirected_to language_path(assigns(:language))
  end
